...
export function initializeIPCHandler(client: Smule) {
    ...
    ipcMain.handle("smule.social.chat.sendReceivedReceipt", async (_event: IpcMainInvokeEvent, to: string | import("../api/smule-types").AccountIcon | import("D:/Desktop/smule-desktop/node_modules/@types/xmpp__jid/index").JID): Promise<void> => await client.social.chat.sendReceivedReceipt(to))
    ...
    ipcMain.handle("smule.social.chat.loadMessageHistory", async (_event: IpcMainInvokeEvent, limit?: number, before?: any, after?: any, user?: string | import("D:/Desktop/smule-desktop/node_modules/@types/xmpp__jid/index").JID): Promise<void> => await client.social.chat.loadMessageHistory(limit, before, after, user))
    ipcMain.handle("smule.social.chat.sendChatState", async (_event: IpcMainInvokeEvent, user: string | import("../api/smule-types").AccountIcon | import("D:/Desktop/smule-desktop/node_modules/@types/xmpp__jid/index").JID, state?: import("../api/smule-chat-types").SmulePartnerStatus): Promise<void> => await client.social.chat.sendChatState(user, state))
