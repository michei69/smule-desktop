...
export function initializeIPCHandler(client: Smule) {
    ...
    ipcMain.handle("smule.social.chat.sendTextMessage", async (_event: IpcMainInvokeEvent, to: string | import("../api/smule-types").AccountIcon | import("D:/Desktop/smule-desktop/node_modules/@types/xmpp__jid/index").JID, message: string): Promise<void> => await client.social.chat.sendTextMessage(to, message))
    ipcMain.handle("smule.social.chat.sendPerformanceMessage", async (_event: IpcMainInvokeEvent, to: string | import("../api/smule-types").AccountIcon | import("D:/Desktop/smule-desktop/node_modules/@types/xmpp__jid/index").JID, performanceKey: string): Promise<void> => await client.social.chat.sendPerformanceMessage(to, performanceKey))
    ipcMain.handle("smule.social.chat.sendReceivedReceipt", async (_event: IpcMainInvokeEvent, to: string | import("../api/smule-types").AccountIcon | import("D:/Desktop/smule-desktop/node_modules/@types/xmpp__jid/index").JID, messageId: string): Promise<void> => await client.social.chat.sendReceivedReceipt(to, messageId))
    ipcMain.handle("smule.social.chat.fetchChats", async (_event: IpcMainInvokeEvent): Promise<{ [key: number]: import("../api/smule-chat-types").SmuleChatContainer; }> => await client.social.chat.fetchChats())
    ipcMain.handle("smule.social.chat.fetchChat", async (_event: IpcMainInvokeEvent, user: number): Promise<import("../api/smule-chat-types").SmuleChatContainer> => await client.social.chat.fetchChat(user))
    ipcMain.handle("smule.social.chat.fetchMessageHistory", async (_event: IpcMainInvokeEvent, limit?: number, before?: any, after?: any, user?: string | import("D:/Desktop/smule-desktop/node_modules/@types/xmpp__jid/index").JID): Promise<void> => await client.social.chat.loadMessageHistory(limit, before, after, user))
    ipcMain.handle("smule.social.chat.sendChatState", async (_event: IpcMainInvokeEvent, state?: import("../api/smule-chat-types").SmulePartnerStatus): Promise<void> => await client.social.chat.sendChatState(state))
    ipcMain.handle("smule.social.chat.getUserIdFromJID", async (_event: IpcMainInvokeEvent, userId: string | number): Promise<number> => await client.social.chat.getUserIdFromJID(userId))
    ...
    ipcMain.handle("smule.TEST.inviteViaChat", async (_event: IpcMainInvokeEvent, accountIds: number[], performanceKey: string): Promise<any> => await client.TEST.inviteViaChat(accountIds, performanceKey))
}